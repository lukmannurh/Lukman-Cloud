...
description: UI UX design intelligence skill
---
...
```
`--variance` biases style selection (centered/minimal â†’ bold/asymmetric), `--motion` attaches a matching GSAP snippet from `motion.csv`, `--density` overrides the spacing-scale tokens (spacious â†’ dense/dashboard). Any dial left unset behaves exactly as before.
...
â”œâ”€â”€ data/                         # Canonical CSV databases
â”‚   â”œâ”€â”€ products.csv, styles.csv, colors.csv, typography.csv, ...
â”‚   â””â”€â”€ stacks/                   # Stack-specific guidelines
â”œâ”€â”€ scripts/
â”‚   â”œâ”€â”€ search.py                 # CLI entry point
â”‚   â”œâ”€â”€ core.py                   # BM25 + regex hybrid search engine
â”‚   â””â”€â”€ design_system.py          # Design system generation
â””â”€â”€ templates/
    â”œâ”€â”€ base/                     # Base templates (skill-content.md, quick-reference.md)
    â””â”€â”€ platforms/                # Platform configs (claude.json, cursor.json, ...)

cli/                              # CLI installer (ui-ux-pro-max-cli on npm)
â”œâ”€â”€ src/
â”‚   â”œâ”€â”€ commands/init.ts          # Install command with template generation
â”‚   â””â”€â”€ utils/template.ts         # Template rendering engine
â”œâ”€â”€ scripts/sync-assets.mjs       # Mirrors src/ -> cli/assets/ AND src/ -> .claude/skills/ui-ux-pro-max/
â””â”€â”€ assets/                       # Bundled assets (~564KB)
    â”œâ”€â”€ data/                     # Copy of src/ui-ux-pro-max/data/
    â”œâ”€â”€ scripts/                  # Copy of src/ui-ux-pro-max/scripts/
    â””â”€â”€ templates/                # Copy of src/ui-ux-pro-max/templates/
